...
func newMessageAttribution(promptUserMessageID string) *messageAttribution {
...
func (a *messageAttribution) assistantDisposition(messageID, parentID string, isSummary bool) assistantDisposition {
	...
	if parentMatches || a.isAssistantAllowed(messageID) || a.compactionFallbackAccepts(messageID) {
...
func (a *messageAttribution) compactionFallbackAccepts(messageID string) bool {
	return a.compactionOccurred && idIsAfter(messageID, a.promptUserMessageID)
}
